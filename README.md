...
**Detector dataset** can be generated by [SynthText](https://github.com/ankush-me/SynthText). Run exporting script for PaddleOCR finally and place it to `train_data/aurebesh/det/` in this repository.

**Recognizer dataset** can be generated by [synthtiger](https://github.com/clovaai/synthtiger). Run exporting script for PaddleOCR finally and place it to `train_data/aurebesh/rec/` in this repository.
